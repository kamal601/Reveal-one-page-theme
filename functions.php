...
if ( ! function_exists( 'reveal_setup' ) ) :
	...
	function reveal_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'reveal_custom_background_args', array(
...
function reveal_scripts() {
	wp_enqueue_style( 'reveal-style', get_stylesheet_uri() );

	wp_enqueue_script( 'reveal-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'reveal-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
